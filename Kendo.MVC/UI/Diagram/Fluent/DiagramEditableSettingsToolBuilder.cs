namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public class DiagramEditableSettingsToolBuilder<TShapeModel, TConnectionModel> : IHideObjectMembers
        ...
        where TConnectionModel : class
    {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Name(string value)
        {
        ...
        public DiagramEditableSettingsToolBuilder<TShapeModel,TConnectionModel> Step(double value)
        {
